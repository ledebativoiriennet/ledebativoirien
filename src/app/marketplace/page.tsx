        ...
        {newspapers.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {newspapers.map((paper) => (
              <div key={paper.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 group flex flex-col">
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100">
                    <Link
                      ...
                      className="w-full block text-center bg-red-600 hover:bg-red-700 text-white font-medium py-3 px-4 rounded-xl transition-colors duration-200"
                    >
                      Acheter le PDF
                    </Link>
                  </div>
